...
Route::group(['middleware' => ['locale']], function () { 
    ...
    Route::match(array('GET', 'POST'),'update-home-page/old', 'HomeController@update_oldhome');
    Route::match(array('GET', 'POST'),'update-home-page/new', 'HomeController@update_newhome');
