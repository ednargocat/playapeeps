    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($users) {
                ...
                $delete = \Helpers::has_permission(Auth::guard('admin')->user()->id, 'edit_customer') ?'<a href="' . url('admin/delete-customer-view/' . $users->id) . '" class="btn btn-sm svbtn"><i class="fa fa-trash"></i></a>&nbsp;' : '';
