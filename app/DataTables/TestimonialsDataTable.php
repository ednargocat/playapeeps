        ...
        return datatables()
            ...
            ->addColumn('action', function ($testimonials) {
                ...
                if (Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_testimonial')) {
                    $edit = '<a href="' . url('admin/edit-testimonials/' . $testimonials->id).'" class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a>';
                }
                if (Common::has_permission(\Auth::guard('admin')->user()->id, 'delete_testimonial')) {
                    $delete = '<a href="' . url('admin/delete-testimonials/' . $testimonials->id) . '" class="btn btn-xs svbtn delete-warning"><i class="glyphicon glyphicon-trash"></i></a>';
                }
                return $edit . $delete;
            })
