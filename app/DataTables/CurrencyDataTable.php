    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($currency) {
                ...
                $edit = '<a href="' . url('admin/settings/edit-currency/' . $currency->id) . '" class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a>';
                if ($currency->id != $homeCurrency->value) {
                    $delete = '<a href="' . url('admin/settings/delete-currency/' . $currency->id) . '" class="btn btn-xs svbtn delete-warning"><i class="glyphicon glyphicon-trash"></i></a>';
                } else {
                    $delete = '';
                }
