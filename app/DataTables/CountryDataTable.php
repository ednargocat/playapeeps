    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($country) {
                ...
                $edit = '<a href="' . url('admin/settings/edit-country/' . $country->id) . '" class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a>';
                $delete = '<a href="' . url('admin/settings/delete-country/' . $country->id) . '" class="btn btn-xs svbtn delete-warning"><i class="glyphicon glyphicon-trash"></i></a>';
