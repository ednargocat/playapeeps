    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function ($startingCities) {
                return '<a target="_blank" href="' . url('admin/settings/edit-starting-cities/' . $startingCities->id) . '" class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a><a href="' . url('admin/settings/delete-starting-cities/' . $startingCities->id) . '" class="btn btn-xs svbtn delete-warning"><i class="glyphicon glyphicon-trash"></i></a>';
            })
