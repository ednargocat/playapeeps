    ...
    public function ajax()
    {
        ...
        ->addColumn('action', function ($withDrawal) {
            if ($withDrawal->status == 'Pending') {
                return '<a href="' . url('admin/payouts/edit/' . $withDrawal->id) . '" class="btn btn-xs svbtn" title="Edit payout"><i class="fa fa-pencil"></i></a>';
            }else{
                return '<a href="' . url('admin/payouts/details/' . $withDrawal->id) . '" class="btn btn-xs svbtn" title="Details"><i class="glyphicon glyphicon-tasks"></i></a>&nbsp;';
