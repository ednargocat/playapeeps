				...
				<form method="post" action="hotel_date_package/" class='form-horizontal' id='dtpc_form'>
					...
					<div class="form-group hide">
                        <div class="col-md-12 p-0">
                          ...
                          <input type="number" class="form-control text-14" name="minstay" id='dtpc_stay' placeholder = "Day..">
					...
					<div class="form-group hide">
                        <div class="col-md-12 p-0">
                          ...
                          <input type="number" class="form-control text-14" name="maxstay" id='maxstay' placeholder = "Day..">
					...
					<div class="form-group">
						<div class="col-md-12 p-0">
							...
							<select class="form-control text-14" name="status" id="dtpc_status">
								...
								<option value="Available">{{trans('messages.experience.available')}}</option>
								<option value="Not available">{{trans('messages.experience.not_available')}}</option>
							</select>
			...
			<div class="main-panel">
				<div class="row">
					<div class="col-md-6 p-0 sv_step_three">
							 <img src="{{ $experience_ninth_img }}" class="img-fluid">
    			        <div>
               				<h3 class="text-center text-52 font-weight-700">{{trans('messages.listing_basic.property_days')}}</h3>
                        </div>
						</div>

					<div class="col-md-6 mt-sm-0 pl-5 mob-pd-lft pb-5 mb-5">
						...
						<div class="row justify-content-between mt-4 mb-5">
							<div class="mt-4">
								<a  data-prevent-default="" href="{{ url('experience/'.$result->id.'/booking') }}" class="btn btn-outline-danger secondary-text-color-hover text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3">
									{{trans('messages.listing_description.back')}}
								</a>
							</div>

							<div class="mt-4">
							<a  data-prevent-default="" href="{{ url('properties/'.$result->id.'/'.$result->slug) }}" class="btn vbtn-default text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3" id="btn_next">
