		...
		<div class="nav-tabs-custom">
			<ul class="cus nav nav-tabs" role="tablist">
				...
				<li  class="{{ isset($properties_tab) ? $properties_tab : '' }}">
					<a href='{{url("admin/customer/properties")}}/{{@$user->id}}' >Listing</a>
				</li>
				
				<li class="{{ isset($bookings_tab1) ? $bookings_tab1 : '' }}">
					<a href='{{url("admin/customer/mybooking")}}/{{@$user->id}}'>Bookings</a>
				</li>
				
				<li class="{{ isset($bookings_tab) ? $bookings_tab : '' }}">
					<a href='{{url("admin/customer/trips")}}/{{@$user->id}}'>Trips</a>
				</li>
...
<h3 class="white_color">{{ @$user->first_name." ".@$user->last_name }}</h3>