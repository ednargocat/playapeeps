    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <form class="form-horizontal" action="{{url('admin/settings/edit-property-type/'.$result->id)}}" id="edit_property" method="post" name="edit_property" accept-charset='UTF-8' enctype="multipart/form-data" {{-- onsubmit="return contentValidate();" --}}>
            {{ csrf_field() }}
            ...
            <div class="form-group">
                 ...
                 <div class="col-sm-6">
                   ...
                   @if(isset($result->icon))
                        <img src="{{ url('/') }}/public/images/property_type/{{$result->icon}}" width="50px">
                    @endif
                 </div>
             </div>
