      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Add Amenity Type</h3>
          </div>
          <!-- form start -->
          <form class="form-horizontal" action="{{url('admin/settings/add-amenities-type')}}" id="add_amenity" method="post" name="add_amenity" accept-charset='UTF-8' enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="box-body">
