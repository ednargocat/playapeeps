						...
						<div class="">
							<div class="container margin-top30 mb30">
								...
								<div class="col-md-2 col-sm-2 col-xs-12">
									<div class="panel-default row-space-4">
										...
										<div class="va-middle">
											<div class="h4">
											<center><a class="" href="{{ url('admin/edit-customer/'.$messages[0]->bookings->user_id) }}">{{ $messages[0]->bookings->users->first_name.' '. $messages[0]->bookings->users->last_name }}</a></center>
