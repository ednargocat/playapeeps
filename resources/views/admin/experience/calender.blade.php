                  ...
                  <form method="post" action="admin/hotel_date_package/" class='form-horizontal' id='dtpc_form'>
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group hide">
                        ...
                        <div class="col-sm-6">
                          <input type="number" min="1" class="form-control" name="min_stay" id='dtpc_minstay_admin' placeholder = "">
                          <span class="text-danger" id="error-dtpc-minstay">{{ $errors->first('minstay') }}</span>
                        </div>
                      </div>
                        
                        <div class="form-group hide">
                        <label for="input_dob" class="col-sm-3 control-label">Maximum Stay </label>
                        <div class="col-sm-6">
                          <input type="number" min="1" class="form-control" name="max_stay" id='dtpc_maxstay_admin' placeholder = "">
                          <span class="text-danger" id="error-dtpc-maxstay">{{ $errors->first('maxstay') }}</span>
                        </div>
                      </div>
                    ...
                    <div class="modal-footer">
                      <button class="btn btn-primary pull-right" type="submit" name="submit">{{trans('messages.listing_calendar.submit')}}</button>&nbsp;
              ...
              <form method='post' action="admin/property-save/{{$result->id}}/pricing">
                ...
                <div class="row">
                  <div class="col-md-6 col-sm-6 col-xs-6 text-left mt-30">
                    <a data-prevent-default="" href="{{ url('admin/experience/'.$result->id.'/booking') }}" class="btn btn-large btn-default">{{trans('messages.listing_description.back')}}</a>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-6 text-right mt-30">
                    <a data-prevent-default="" href="{{ url('admin/experience') }}" class="btn btn-large btn-primary">{{trans('messages.listing_calendar.your_list')}}</a>
                  </div>
                </div>
              </form>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="row">
                <div class="col-md-4 col-sm-12 col-xs-12 text-left mt-30">
                  <button class="text-muted btn btn-success imporpt_calendar">Import Calendar</button>
                </div>
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 mt-30">
                  <button class="text-muted btn btn-success" id="export_icalendar">Export Calendar</button> 
                </div>
              </div>
            </div>
          </div>
