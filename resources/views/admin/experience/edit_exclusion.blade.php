      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Edit Exclusion</h3>
          </div>
          <!-- form start -->
		  
          <form class="form-horizontal" action="{{url('admin/experience/edit_exclusion/'.$result->id)}}" id="edit_exclusion" method="post" name="edit_exclusion" accept-charset='UTF-8' {{-- onsubmit="return contentValidate();" --}}>
            {{ csrf_field() }}
            ...
            <div class="box-body">
			 ...
			 <div class="box-group" id="accordion">
				...
				<?php 
					$query = App\Models\Exclusion::where([ ['temp_id',$result->id],['lang_id', $language->id ]])->first();
				?>
