...
@section('main')
  ...
  <section class="content">
      ...
      <div class="col-md-9">
      <form id="list_des" method="post" action="{{url('admin/experience/'.$result->id.'/'.$step)}}" class='signup-form login-form' accept-charset='UTF-8'>
        {{ csrf_field() }}
		...
		<ul class="nav nav-tabs mt-3 ml-3 sv_translation_tab">
          ...
          <div class="row">
            <div class="col-md-6  col-sm-6 col-xs-6 text-left">
                <a data-prevent-default="" href="{{ url('admin/experience/'.$result->id.'/basics') }}" class="btn btn-large btn-default">{{trans('messages.listing_description.back')}}</a>
            </div>
