      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Add Experience Category</h3>
          </div>
          <!-- form start -->
          <form class="form-horizontal" action="{{url('admin/experience/add_experience_category')}}" id="add_experience_category" method="post" name="add_experience_category" accept-charset='UTF-8' enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="box-body">
