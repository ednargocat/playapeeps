      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Edit Inclusion</h3>
          </div>
          <!-- form start -->
		  
          <form class="form-horizontal" action="{{url('admin/experience/edit_inclusion/'.$result->id)}}" id="edit_inclusion" method="post" name="edit_inclusion" accept-charset='UTF-8' {{-- onsubmit="return contentValidate();" --}}>
            {{ csrf_field() }}
            ...
            <div class="box-body">
			 ...
			 <div class="box-group" id="accordion">
				...
				<?php 
					$query = App\Models\Inclusion::where([ ['temp_id',$result->id],['lang_id', $language->id ]])->first();
				?>
