		...
		<div class="col-lg-12 p-0">
			<div class="main-panel">
				<div class="container-fluid container-fluid-90">
					<div class="col-md-12 mt-5 p-0 pb-5">
						<div class="row">
									...
									<div class="row mt-4 border rounded-3">
										<div class="col-md-3 col-xl-4 pl-0 pr-0">
											<div class="img-event p-3">
												<a href="{{ url('/') }}/properties/{{$reviewsAboutYou[$i]->properties->id}}/{{$reviewsAboutYou[$i]->properties->slug}}">
										...
										<div class="col-md-9 col-xl-8 pl-3 pr-3">
											<div class="row align-items-center pt-2 pb-2">
												<a href="{{ url('/') }}/properties/{{$reviewsAboutYou[$i]->properties->id}}/{{$reviewsAboutYou[$i]->properties->slug}}"><p class="font-weight-700 mb-0">{{ $reviewsAboutYou[$i]->properties->name }} </p></a>
											</div>
